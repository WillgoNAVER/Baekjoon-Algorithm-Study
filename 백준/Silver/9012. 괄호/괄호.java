...
public class Main {
    ...
    // 한 쌍의 괄호 기호로 된 “( )” 문자열은 기본 VPS 이라고 부른다. 만일 x 가 VPS 라면 이것을 하나의 괄호에 넣은 새로운 문자열
    // “(x)”도 VPS 가 된다.
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < T; i++) {
            String bracket[] = reader.readLine().split("");
            Stack stack = new Stack(bracket.length);
            boolean error = false;
